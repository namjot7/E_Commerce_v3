...
export const shippingAddressSchema = z.object({
    fullName: z.string().min(3, 'Name must have atleast 3 characters.'),
    streetAddress: z.string().min(3, 'streetAddress must have atleast 3 characters.'),
    city: z.string().min(3, 'city must have atleast 3 characters.'),
    country: z.string().min(3, 'country must have atleast 3 characters.'),
    postalCode: z.string().min(3, 'postalCode must have atleast 3 characters.'),
